    ...
    def _build_static_map_url(self, listings):
        ...
        for listing in map_listings:
            ...
            if address and address != 'N/A':
                # Clean up address and append New York, NY for accurate geocoding
                address_clean = address.replace('#', '').strip()
                address_with_city = f"{address_clean}, New York, NY"
                markers.append(f"markers=color:red%7C{quote(address_with_city)}")
